...
<body>
	<form id="addForm" class="form-horizontal" method="post">
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" class="form-control" id="cronExpression" name="cronExpression" placeholder="如 0/5 * * * * ?" >
			</div>
		</div>
		<div class="form-group">
			<label for="beanClass" class="col-sm-3 control-label">任务类</label>
			<div class="col-sm-6">
				<input type="text" class="form-control" id="beanClass" name="beanClass" placeholder="如 com.woyi.mhub.TestJob">
			</div>
		</div>
